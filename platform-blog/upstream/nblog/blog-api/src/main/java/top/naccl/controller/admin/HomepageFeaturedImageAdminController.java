 ...
 */
@RestController
@RequestMapping("/admin/homepage-featured-images")
public class HomepageFeaturedImageAdminController {
    private final HomepageFeaturedImageService service;

    public HomepageFeaturedImageAdminController(HomepageFeaturedImageService service) {
